...
## Release 1.11
- FIX : BACKPORT Sentry - Add null check before setting _renderItem on jQuery UI autocomplete widget - *2026-03-27* - 1.11.2
- FIX : Remove remaining Abricot dependency and replace relation rowid lookup with native Dolibarr SQL - *2026-02-17* - 1.11.1
