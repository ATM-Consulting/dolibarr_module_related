...
class modRelated extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//							'css' => array('/related/css/related.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/related/js/related.js'),          // Set this to relative path of js file if module must load a js on all pages
		//							'hooks' => array('hookcontext1','hookcontext2')  	// Set here all hooks context managed by module
		//							'dir' => array('output' => 'othermodulename'),      // To force the default directories names
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'isModEnabled('module1') && isModEnabled('module2')', 'picto'=>'yourpicto@related')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array(
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@related:$user->hasRight('related', 'read'):/related/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:mylangfile@related:$user->hasRight('othermodule', 'read'):/related/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        /* Example:
        if (! isModEnabled('related')) $conf->related->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            'langs'=>'mylangfile@related',
            ...
            'tabcond'=>array(isModEnabled('related'),isModEnabled('related'),isModEnabled('related'))												// Condition to show each dictionary
        );
        */
		...
		//							'titre'=>'Related top menu',
		//							'mainmenu'=>'related',
		//							'leftmenu'=>'related',
		//							'url'=>'/related/pagetop.php',
		//							'langs'=>'mylangfile@related',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'isModEnabled('related')',	// Define condition to show or hide menu entry. Use 'isModEnabled('related')' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight('related', 'level1', 'level2')' if you want your menu with a permission rules
		//							'target'=>'',
		...
		//							'titre'=>'Related left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'related',
		//							'url'=>'/related/pagelevel2.php',
		//							'langs'=>'mylangfile@related',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'isModEnabled('related')',  // Define condition to show or hide menu entry. Use 'isModEnabled('related')' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight('related', 'level1', 'level2')' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
