...
class modRelated extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//                        );
		$this->module_parts = array(
			'hooks'=>array('commonobject','actioncard','projectcard', 'contactcard', 'globalcard')
			,'triggers' => 1
		);
        ...
        /* Example:
        if (! isset($conf->related->enabled)) $conf->related->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->related->enabled,$conf->related->enabled,$conf->related->enabled)												// Condition to show each dictionary
        );
        */
		...
		//							'position'=>100,
		//							'enabled'=>'$conf->related->enabled',	// Define condition to show or hide menu entry. Use '$conf->related->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->related->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		...
		//							'langs'=>'mylangfile@related',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->related->enabled',  // Define condition to show or hide menu entry. Use '$conf->related->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->related->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
